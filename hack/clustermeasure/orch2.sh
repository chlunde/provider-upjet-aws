...
run_arm ctrl-rerun GODEBUG=disablethp=1 UPJET_PPROF_ADDR=:6060
run_arm trim GODEBUG=disablethp=1 BIN=provider-trim UPJET_PPROF_ADDR=:6060
run_arm trim-memlimit200 GODEBUG=disablethp=1 GOMEMLIMIT=200MiB BIN=provider-trim UPJET_PPROF_ADDR=:6060
run_arm trim-filter UPJET_FAMILY_FILTER=s3 GODEBUG=disablethp=1 BIN=provider-trim UPJET_PPROF_ADDR=:6060
run_arm lim300-gml250-thp PODLIMIT=300Mi GOMEMLIMIT=250MiB
run_arm lim300-gml250-nothp PODLIMIT=300Mi GOMEMLIMIT=250MiB GODEBUG=disablethp=1
run_arm lim256-trim-filter BIN=provider-trim PODLIMIT=256Mi UPJET_FAMILY_FILTER=s3 GODEBUG=disablethp=1 GOMEMLIMIT=200MiB
mark "MATRIX DONE"
